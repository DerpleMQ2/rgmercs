...
function Module:RenderCmdRow(cmd, usage, desc)
	...
	ImGui.TextColored(Config.Constants.Colors.LightOrange, cmd)
	ImGui.TableNextColumn()
	ImGui.TextColored(Config.Constants.Colors.LightBlue, usage)
	ImGui.TableNextColumn()
	ImGui.PushStyleColor(ImGuiCol.Text, Config.Constants.Colors.LightGreen)
