    ...
    ['Rotations']         = {
        ...
        ['DPS'] = {
            ...
            },
            {
                ...
                cond = function(self, discSepll)
                    return not mq.TLO.Me.ActiveDisc.ID() and not RGMercUtils.SongActive(discSepll.RankName.Name() or "") and mq.TLO.Me.PctEndurance() < 30
                end,
            },
        },
        ['DPS Buffs'] = {
