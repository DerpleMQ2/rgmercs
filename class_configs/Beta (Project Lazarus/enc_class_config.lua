...
local _ClassConfig = {
    ...
    ['Spells']          = {
        {
            ...
            spells = {
                ...
                { name = "ColoredNuke",      cond = function(self) return Config:GetSetting('DoNuke') end, },
                { name = "Chromaburst",      cond = function(self) return Config:GetSetting('DoNuke') end, },
    ...
    ['DefaultConfig']   = {
        ...
        ['DoNuke']             = {
            ...
            Category = "DPS",
            Index = 1,
            Tooltip = "Use your magic nukes (to include Colored Chaos and Chromablast).",
            RequiresLoadoutChange = true,
            Default = true,
