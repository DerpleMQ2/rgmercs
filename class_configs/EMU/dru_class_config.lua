    ...
    ['Rotations']         = {
        ['DPS'] = {
            {
                ...
                cond = function(self, spell)
                    ...
                    return Config:GetSetting('DoSnare') and not mq.TLO.Target.Snared()
                end,
            },
            {
                name = "SunrayDot",
        ...
        ['Debuff'] = {
            ...
            },
            {
                ...
                type = "AA",
                cond = function(self, aaName)
                    return Config:GetSetting('DoSnare') and Casting.DetAACheck(aaName) and not mq.TLO.Target.Snared()
                end,
            },
            {
                name = "SnareSpell",
