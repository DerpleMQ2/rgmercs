...
local _ClassConfig = {
    ...
    ['PullAbilities']   = {
        ...
        },
        {
            id = 'SnareDot',
            Type = "Spell",
            DisplayName = function() return Core.GetResolvedActionMapItem('SnareDot').RankName.Name() or "" end,
            AbilityName = function() return Core.GetResolvedActionMapItem('SnareDot').RankName.Name() or "" end,
            AbilityRange = 200,
            cond = function(self)
                local resolvedSpell = Core.GetResolvedActionMapItem('SnareDot')
                if not resolvedSpell then return false end
                return mq.TLO.Me.Gem(resolvedSpell.RankName.Name() or "")() ~= nil
            end,
        },
