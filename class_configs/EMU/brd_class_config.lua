...
local Tooltips    = {
    ...
    ResistSong      = "Song Line: Damage Shield / Group Resist Increase, Higher Lvl",
    ResistFireCold  = "Song Line: Fire and Cold Resist",
    ResistPoiDis    = "Song Line: Poison and Disease Resist",
    ResistMagic     = "Song Line: Magic Resist / SpellShield / DS",
...
local function generateSongList()
    ...
    local function AddTankSongs()
        ...
        ConditionallyAddSong("UseResFireCold", "FireColdResist", 9, "combo")
        ConditionallyAddSong("UseResPoiDis", "PoiDisResist", 13, "combo")
        ConditionallyAddSong("UseResMagic", "MagicResist", 17, "combo")
    end
...
local _ClassConfig = {
    ...
    ['RotationOrder']   = {
        {
            ...
            cond = function(self, combat_state)
                return not (combat_state == "Downtime" and mq.TLO.Me.Invis()) and
                    not (Config:GetSetting('BardRespectMedState') and Config.Globals.InMedState)
            end,
        },
        {
            name = 'Downtime',
    ...
    ['Rotations']       = {
        ...
        ['Melody'] = {
            ...
            },
            {
                ...
                type = "Song",
                cond = function(self, songSpell)
                    if Config:GetSetting('UseResFireCold') == 1 then return false end
                    return self.ClassConfig.HelperFunctions.CheckSongStateUse(self, "UseResFireCold") and self.ClassConfig.HelperFunctions.RefreshBuffSong(songSpell)
                end,
            },
            {
                name = "PoiDisResist",
                type = "Song",
                cond = function(self, songSpell)
                    if Config:GetSetting('UseResPoiDis') == 1 then return false end
                    return self.ClassConfig.HelperFunctions.CheckSongStateUse(self, "UseResPoiDis") and self.ClassConfig.HelperFunctions.RefreshBuffSong(songSpell)
                end,
            },
            {
                name = "MagicResist",
                type = "Song",
                cond = function(self, songSpell)
                    if Config:GetSetting('UseResMagic') == 1 then return false end
                    return self.ClassConfig.HelperFunctions.CheckSongStateUse(self, "UseResMagic") and self.ClassConfig.HelperFunctions.RefreshBuffSong(songSpell)
                end,
            },
            {
                name = "RecklessSong",
    ...
    ['DefaultConfig']   = {
        ...
        ['UseResFireCold']      = {
            DisplayName = "Use FR / CR Resist Hymn",
            Category = "Buffs and Defenses",
            Index = 5,
            Tooltip = Tooltips.ResistFireCold,
            Type = "Combo",
            ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', },
            Default = 1,
            Min = 1,
            Max = 4,
            RequiresLoadoutChange = true,
            FAQ = "How do I use my FR / CR Resist Hymn",
            Answer = "You can enable the FR / CR Resist Hymn in the Buffs and Defenses tab." ..
                "Options are (Never, In-Combat Only, Always, Out-of-Combat Only).",
        },
        ['UseResPoiDis']        = {
            DisplayName = "Use PR / DR Resist Hymn",
            Category = "Buffs and Defenses",
            Index = 5,
            Tooltip = Tooltips.ResistPoiDis,
            Type = "Combo",
            ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', },
            Default = 1,
            Min = 1,
            Max = 4,
            RequiresLoadoutChange = true,
            FAQ = "How do I use my PR / DR Resist Hymn?",
            Answer = "You can enable the PR / DR Resist Hymn in the Buffs and Defenses tab." ..
                "Options are (Never, In-Combat Only, Always, Out-of-Combat Only).",
        },
        ['UseResMagic']         = {
            DisplayName = "Use DS/Resist Hymn",
            Category = "Buffs and Defenses",
            Index = 5,
            Tooltip = Tooltips.ResistMagic,
            Type = "Combo",
            ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', },
            Default = 1,
            Min = 1,
            Max = 4,
            RequiresLoadoutChange = true,
            FAQ = "How do I use my Damage Shield / Resist Hymn?",
            Answer = "You can enable the DS/Resist Hymn in the Buffs and Defenses tab." ..
                "Options are (Never, In-Combat Only, Always, Out-of-Combat Only).",
        },
        ['UseReckless']         = {
