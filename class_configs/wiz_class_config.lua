...
return {
    ...
    ['DefaultConfig'] = {
        ...
        ['RainDist']        = { DisplayName = "Min Dist for Rains", Category = "Combat", Tooltip = "If you are closer you will not use Rain spells", Default = 30, Min = 0, Max = 100, },
        ['RainMinHaters']   = { DisplayName = "Min XTHaters for Rains", Category = "Combat", Tooltip = "If you are closer you will not use Rain spells", Default = 3, Min = 1, Max = 100, },
        ['RainMinTargetHP'] = { DisplayName = "Min Target HP for Rains", Category = "Combat", Tooltip = "Wait until the group target is at [x] HP before firing Rains", Default = 90, Min = 1, Max = 100, },
