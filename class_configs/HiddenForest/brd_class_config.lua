...
local _ClassConfig = {
    _version            = "3.1 - The Hidden Forest WIP",
    ...
    ['AbilitySets']     = {
        ...
        ['GroupRegenSong'] = {
            ...
            "Znoth's Chorus of Clarity",        -- 32, mana only
            "Znoth's Chant of Clarity",         -- 20, mana only
        ...
        ['PoisonDotSong'] = {
            ...
            "Znoth's Chant of Venom",
            "Znoth's Chant of Poison",
        },
        ['DiseaseDotSong'] = {
            "Vulka's Chant of Disease",
            "Znoth's Chant of the Plague",
            "Znoths's Chant of Disease",
        },
        ['CureSong'] = {
