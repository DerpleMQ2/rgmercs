...
return {
    ...
    ['HelperFunctions'] = {
        PreEngage = function(target)
            ...
            if mq.TLO.Me.CombatAbilityReady(openerAbility)() and not mq.TLO.Me.AbilityReady("Hide")() and mq.TLO.Me.AbilityTimer("Hide")() < ((mq.TLO.Me.AbilityTimerTotal("Hide")() or 10000) - 4000) and mq.TLO.Me.Invis() then
