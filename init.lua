...
local function RGInit(...)
    ...
    printf("\aw****************************")
    printf("\agDefault Configs have been updated on 3/24/2025:")
    printf("\agENC has a new beta (for Live and Laz configs) focusing on 1-70!")
    printf("\agWIZ Live Alpha has had mid-levels added and is advanced to Beta.")
