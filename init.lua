...
local function RGInit(...)
    ...
    printf("\aw****************************")
    printf("\agDefault Configs have been updated on 3/30/2025:")
    printf("\agDruid Laz Alpha has been rewritten and is advanced to Beta.")
    printf("\agENC Beta files have been made default again.")
    printf("\agWIZ Live Beta continues.")
