...
local function RGInit(...)
    ...
    printf("\aw****************************")
    printf("\agBeta Configs have been updated on 1/31/2025!")
    printf("\agNew Beta configs: ROG, MNK, CLR. Please provide feedback if able!")
    printf("\agEmu servers: New version of LootNScoot integrated! Please check forums.")
